...
$table = "<table border='1'>
          <thead>
          <tr>
          <th style='text-align:center;' style='background-color: #8ea9db;' colspan=7>DUE FEE</th>
          </tr>
          ...
          <th style='text-align:center;' style='background-color: #8ea9db;'>STUDENT NAME</th>
          ...
          <th style='text-align:center;' style='background-color: #8ea9db;'>CONTACT NO.</th>
          <th style='text-align:center;' style='background-color: #8ea9db;'>FEE</th>
          </tr>
          </thead>";
          ...
          header("Content-Disposition: attachment; filename=DueFeeReport(".date('d-M-Y').").xls");
          echo $table;
