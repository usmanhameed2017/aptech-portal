...
<div class="container-fluid">
    <form id="manage-fees">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="ef_no" value="<?php echo isset($ef_no) ? $ef_no :'' ?>"
                required>
        </div>
        <div class="form-group">
            ...
            <select name="student_id" id="student_id" class="custom-select input-sm select2">
                ...
                <option value="<?php echo $row['id'] ?>"
                    <?php echo isset($student_id) && $student_id == $row['id'] ? 'selected' : '' ?>>
                    <?php echo ucwords($row['name']).' | '. $row['id_no'] ?></option>
                <?php endwhile; ?>
            </select>
        </div>
        <div class="form-group">
            ...
            <select name="course_id" id="course_id" class="custom-select input-sm select2">
                ...
                <option value="<?php echo $row['id'] ?>" data-amount="<?php echo $row['total_amount'] ?>"
                    <?php echo isset($course_id) && $course_id == $row['id'] ? 'selected' : '' ?>>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control text-right" name="total_fee"
