            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <b>List of Logs</b>
                        <button class="btn btn-success btn-block btn-sm col-sm-2 float-right mr-2 mt-0" type="button"
                            id="print_record">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-sm-3">
                                <input type="date" name="date" id="date"
                                    value="<?php echo date('Y-m-d',strtotime($date)) ?>" class="form-control">
                            </div>
                        </div>
                        <hr>
                        <table class="table table-condensed table-bordered table-hover" id="log-records">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p> <b><?php echo date("M d, Y h:i A",strtotime($row['date_created'])) ?></b>
                                        </p>
                                    </td>
                                    <td class="">
                                        <p>ID Type:
                                            <b><?php echo $row['type'] == 'visitor' ? ($arr_data[$row['type']][$row['frm_id']] ? $arr_data[$row['type']][$row['frm_id']]['id_presented'] : ''):'School ID'  ?></b>
                                        </p>
                                        <p>ID #:
                                            <?php echo $arr_data[$row['type']][$row['frm_id']] ? $arr_data[$row['type']][$row['frm_id']]['id_no'] : '' ?></b>
                                        </p>
                                    </td>
                                    <td>
                                        <p> <b><?php echo ucwords($arr_data[$row['type']][$row['frm_id']] ? $arr_data[$row['type']][$row['frm_id']]['name'] : '') ?></b>
                                        </p>
                                    </td>
                                    <td class="">
