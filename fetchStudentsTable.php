            ...
            "<table class='table table-condensed table-bordered table-hover table-striped' id='studentsTable'>
                <thead>
                    <tr>
                        ...
                        <th scope='col' class='text-center'>Amount In Words</th>
        ...
        "columns": [
            ...
            { 
                "render": function (data, type, full, meta) {
                    ...
                    // Print
                    buttons += `<div class="td-button"><a class="btn btn-secondary text-white" data-title="Print Invoice" href="studentInvoice.php?id=${full.id}"><i class="fa fa-print"></i></a>`;
                    // Edit
